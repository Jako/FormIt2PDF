...
use modX;
use TreehillStudio\FormIt2PDF\FormIt2PDF;
...
abstract class Snippet
{
    ...
    /**
     * A reference to the FormIt2PDF instance
     * @var FormIt2PDF $formit2pdf
     */
    protected $formit2pdf;
    ...
    public function __construct(modX $modx, $properties = [])
    {
        ...
        $corePath = $this->modx->getOption('formit2pdf.core_path', null, $this->modx->getOption('core_path') . 'components/formit2pdf/');
        $this->formit2pdf = $this->modx->getService('formit2pdf', 'FormIt2PDF', $corePath . 'model/formit2pdf/', [
            'core_path' => $corePath
        ]);
