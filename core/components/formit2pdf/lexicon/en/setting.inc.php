...
$_lang['setting_formit2pdf.stationery'] = 'mPDF Stationery';
$_lang['setting_formit2pdf.stationery_desc'] = 'Specify an external PDF file to use as a stationery in the generated PDF. The last page of the exernal PDF file will be repeated, when the generated PDF contains more pages than the external PDF file. The {core_path}, {base_path} and {assets_path} placeholders can be used in this setting.';
...
$_lang['setting_formit2pdf.textTpl'] = 'PDF Content Chunk';
$_lang['setting_formit2pdf.textTpl_desc'] = 'Template chunk for the PDF content. You could use @FILE binding to retreive the chunk from a file.';
