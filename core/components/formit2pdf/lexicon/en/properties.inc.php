...
$_lang['formit2pdf.formit2pdf.pdfCssTpl'] = 'Template chunk for the PDF style';
...
$_lang['formit2pdf.formit2pdf.pdfCustomFontsFolder'] = 'Path to the custom fonts folder. If the path is not set or available, `formit2pdf.customFonts` is not used. The {core_path}, {base_path} and {assets_path} placeholders can be used in this setting.';
