...
$_lang['setting_formit2pdf.customFontsFolder_desc'] = 'Pfad zum Ordner mit den benutzerdefinierten Schriftarten. Wenn der Pfad nicht festgelegt oder verfügbar ist, wird "formit2pdf.customFonts" nicht verwendet. Die Platzhalter {core_path}, {base_path} und {assets_path} können in dieser Einstellung verwendet werden.';
...
$_lang['setting_formit2pdf.stationery'] = 'mPDF Briefbogen';
$_lang['setting_formit2pdf.stationery_desc'] = 'Geben Sie eine externe PDF-Datei an, die als Briefpapier in der generierten PDF-Datei verwendet werden soll. Die letzte Seite der externen PDF-Datei wird wiederholt, wenn die generierte PDF-Datei mehr Seiten als die externe PDF-Datei enthält. Die Platzhalter {core_path}, {base_path} und {assets_path} können in dieser Einstellung verwendet werden.';
