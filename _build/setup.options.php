...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install FormIt2PDF</h2>

        <p>Thanks for installing FormIt2PDF. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade FormIt2PDF</h2>

        <p>FormIt2PDF will be upgraded. This open source extra was developed by
